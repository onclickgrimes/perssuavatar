...
export const ASSET_DEFINITIONS = {
  ...
  video_vo3: {
    ...
    aiDescription: 'Vídeo cinematográfico gerado pelo Google Veo 3 (alta qualidade, movimentos naturais, iluminação realista). Crie um prompt detalhado em inglês para gerar o vídeo.',
  },
  video_static: {
