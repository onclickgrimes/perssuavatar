...
export const TikTokIcon = ({ size = 24, color, className }: TikTokIconProps) => {
  return (
    <svg 
    ...
    >
      <defs>
        <style>
          {`.tiktok-cls-1{fill:${color || '#fe2c55'}}.tiktok-cls-2{fill:${color || '#25f4ee'}}`}
        </style>
      </defs>
      <g>
        <path 
