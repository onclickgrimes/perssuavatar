          ...
          >
            ...
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1">
                ...
                <div className="text-white text-lg leading-relaxed relative mt-6 mb-4">
                            ...
                            >
                              {showUpAction && (
                                <span className="absolute top-1/2 -translate-y-1/2 right-full mr-1 flex flex-col items-center justify-center z-20">
                                  ...
                                  <span className="inline-block whitespace-nowrap bg-black/80 text-yellow-400 text-[10px] font-bold px-1.5 py-0.5 mt-1 rounded border border-yellow-500/50 shadow-[0_0_8px_rgba(234,179,8,0.8)] pointer-events-none">
