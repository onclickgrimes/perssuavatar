            ...
            return knex('channel_niches').insert([
                {
                    ...
                    description: 'Canais sobre história antiga, arqueologia, civilizações antigas',
                    icon: '🏛️',
...
- Durações mais longas (5-8 segundos) para contemplação`,
                ...
                },
                {
                    ...
                    description: 'Canais de meditação, relaxamento, mindfulness e bem-estar',
                    icon: '🧘',
...
- Cores claras e suaves`,
                    ...
                    default_font: 'Lato',
                    components_allowed: JSON.stringify(['WavyGrid', 'GeometricPatterns', 'HighlightWord']),
                    created_at: new Date().toISOString(),
                    updated_at: new Date().toISOString()
                },
                {
